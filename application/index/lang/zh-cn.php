...
return [
    // aq806
    'aq806_mode_auto_on'=>'进入自动模式;',
    'aq806_mode_auto_off'=>'进入手动模式;',
    'aq806_mode_surfing_pump_on'=>'冲浪泵启动了;',
    'aq806_mode_surfing_pump_off'=>'冲浪泵关闭了;',
    'aq806_mode_lamp_on'=>'杀菌灯打开了;',
    'aq806_mode_lamp_off'=>'杀菌灯关闭了;',
    'aq806_mode_light_on'=>'杀菌灯打开了;',
    'aq806_mode_light_off'=>'杀菌灯关闭了;',

    'aq806_event_type_'=>'未知',
    'aq806_event_type_0'=>'无操作',
    'aq806_event_type_1'=>'冲浪水泵异常',
    'aq806_event_type_2'=>'备用电源异常',
    'aq806_event_type_3'=>'照明灯异常',
    'aq806_event_type_4'=>'杀菌灯异常',
    'aq806_event_type_5'=>'水位过低',
    'aq806_event_type_6'=>'水温过低',
    'aq806_event_type_7'=>'水温过高',
    'aq806_event_type_10'=>'数据推送',
    'aq806_event_type_11'=>'动态提示',

    // aph300
    'aph300_event_type_'=>'未知',
    'aph300_event_type_0'=>'无操作',
    'aph300_event_type_1'=>'实时数据推送',
    'aph300_event_type_2'=>'高温报警',
    'aph300_event_type_3'=>'低温报警',
    'aph300_event_type_4'=>'PH过低报警',
    'aph300_event_type_5'=>'PH过高报警',

    // 过滤桶
    'filter_event_type_'=>'未知',
    'filter_event_type_0'=>'无操作',
    'filter_event_type_1'=>'杀菌灯更换维护提示',
    'filter_event_type_2'=>'杀菌灯异常报警(损坏)',
    'filter_event_type_3'=>'清洗开启',
    'filter_event_type_4'=>'清洗电机堵转异常',

    // 加热棒
    'heating_rod_event_type_'=>'未知',
    'heating_rod_event_type_0'=>'无操作',
    'heating_rod_event_type_1'=>'实时温度推送',
    'heating_rod_event_type_2'=>'加热棒过温异常',
    'heating_rod_event_type_3'=>'温度传感器1异常',
    'heating_rod_event_type_4'=>'温度传感器2异常',
    'heating_rod_event_type_5'=>'加热丝开路异常',
    ...
    'aph300'=>'aph300',
    'aq806'=>'aq806',
    'device_notify_title'=>'({:nickname}) {:device_type}的通知',
    'device_notify_content'=>'{:time},{:content}',
    //设备
    'device_cmd_send_success'=>'指令已发送',
    'invalid_ctrl_pwd'=>"设备控制密码无效,请重新绑定设备",

    'equipment_info_notification'=>'设备工作状态通知',
    'equipment_heating_comp'=>'编号{:no}的设备加热完成',
    'equipment_error_notification'=>'备注为({:nickname})的设备温度异常报警通知',
    'equipment_temp_max'=>'设备({:nickname})出现高温报警,当前温度值 {:temp} , 设定高温报警温度 {:temp_max}',
    'equipment_temp_min'=>'设备({:nickname})出现低温报警,当前温度值 {:temp} , 设定低温报警温度 {:temp_min}',
